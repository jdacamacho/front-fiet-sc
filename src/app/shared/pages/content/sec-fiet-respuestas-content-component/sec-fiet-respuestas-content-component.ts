...
@Component({
  selector: 'app-sec-fiet-respuestas-content-component',
  imports: [
    CommonModule,
    CardMainComponent,
    Paginator,
  ...
  templateUrl: './sec-fiet-respuestas-content-component.html',
  styleUrl: './sec-fiet-respuestas-content-component.css'
})
export class SecFietRespuestasContentComponent implements OnInit, AfterViewInit{
